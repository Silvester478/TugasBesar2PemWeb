                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" name="transaction_code" id="transaction_code" type="text" placeholder="TRX/2022-IV/001" value="TRX-IN/<?= date('Y-md/His') ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="example-date-input" class="form-label">Tanggal Barang</label>
...
<script>
    ...
    $('body').on('click', '.addFile', function() {
        ...
        select = "<select name='stock_details[" + no + "][product_id]' data-name='product_id' class='form-control'>";
